...
/// <summary>
/// Runs the shared graph-store chunk-provenance contract suite against Neo4j on a real container.
/// One container and one store serve every fact; the suite keys its rows under fresh ids.
/// </summary>
[Collection("Neo4j")]
[Trait("Category", "Integration")]
public sealed class Neo4jGraphStoreChunkProvenanceContractTests : GraphStoreChunkProvenanceContractSuite, IAsyncLifetime
{
