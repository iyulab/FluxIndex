...
/// <summary>
/// Runs the shared graph-store partition contract suite against the PostgreSQL entity graph
/// store on a real pgvector container. One container and one store serve every fact; the suite works in
/// freshly named partitions.
/// </summary>
[Collection("PostgreSQL")]
[Trait("Category", "Integration")]
public sealed class PostgresEntityGraphStorePartitionContractTests : GraphStorePartitionContractSuite, IAsyncLifetime
{
