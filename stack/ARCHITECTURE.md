...
service/
├── src/
│   ├── FluxIndex.Stack.Api/           # ASP.NET Core Web API
│   │   ├── Controllers/
...
│   │   └── Program.cs
│   │
│   ├── FluxIndex.Stack.Application/   # Business Logic
...
│   │   └── Mappings/
│   │
│   ├── FluxIndex.Stack.Domain/        # Domain Models
│   │   ├── Entities/
│   │   │   ├── Document.cs
│   │   │   ├── Collection.cs
│   │   │   ├── ApiKey.cs
...
│   │   └── ValueObjects/
│   │
│   ├── FluxIndex.Stack.Infrastructure/# External Services
│   │   ├── Persistence/
│   │   │   ├── PostgreSQL/
│   │   │   ├── Neo4j/
│   │   │   └── Redis/
...
│   │       └── EmbeddingProviders/
│   │
│   └── FluxIndex.Stack.Shared/        # Shared DTOs/Contracts
│       ├── DTOs/
│       ├── Contracts/
│       └── Constants/
│
├── tests/
│   ├── FluxIndex.Stack.Api.Tests/
│   ├── FluxIndex.Stack.Application.Tests/
│   └── FluxIndex.Stack.Integration.Tests/
│
└── docker/
    ├── Dockerfile
    ├── docker-compose.yml
...
# Copy and restore
COPY service/src/ ./
RUN dotnet restore FluxIndex.Stack.Api/FluxIndex.Stack.Api.csproj
RUN dotnet publish FluxIndex.Stack.Api/FluxIndex.Stack.Api.csproj \
