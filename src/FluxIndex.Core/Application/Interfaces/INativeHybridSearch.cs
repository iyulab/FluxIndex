...
/// </summary>
/// <remarks>
/// When the registered vector store implements this, a FileVault <c>Hybrid</c> search prefers it over
...
/// <c>IndexDocumentAsync</c>/<c>IKeywordSearchService</c> — which FileVault ingestion does not call —
